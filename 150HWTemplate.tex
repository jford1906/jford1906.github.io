...
\title{MCS 150 Writing Assignment 1}%replace X with the appropriate number
\author{Jeff Ford\\ %replace with your name
\\ %replace with the name of the course
Collaborators: } %if necessary, include the names of everyone you worked with on this.
\date{Today!} %Write the date the assignment is due
