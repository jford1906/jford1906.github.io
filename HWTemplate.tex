...
If you just type stuff, it shows up as you'd expect. If you need special characters, underlining, overlining, italics, bold, Greek letters, or anything else, the commands are all here \url{https://oeis.org/wiki/List_of_LaTeX_mathematical_symbols}.
