...
\begin{thm} 
Delete this text and write the statement you are proving here. You can duplicate this theorem environment if you need to prove multiple theorems in a single problem. If you are doing a Problem, Exercise, or need to include a Lemma, use one of the environments below.
\end{thm}
