...
\begin{thm} 
Delete this text and write the statement you are proving here. You can duplicate this theorem environment if you need to prove multiple theorems in a single problem. If you are doing a Problem, Exercise, or need to include a Lemma, use one of the environments below. Only include what you need.
\end{thm}
...
\begin{lemma}
A lemma to help along the way
\end{lemma}

\rev{2/19/20} %Add another of these whenever you submit a proof or it's revisions. Do not delete this or any of the grades that show up below it.

\begin{proof}
Begin your proof here. You'll want to separate proof environment for each part of your writeup.
